 ...
 <input type="hidden" id="checkreportt" name="checkreportt" value="<?php echo $checkreportt; ?>" />
     ...
     <!--start-->
      ...
      <br/>
       ...
       <br/>
       <input type="text" id="uemail" name="uemail" size="100" class='mobiletext' value="<?Php echo $user["email"]; ?>" />
       <br/>
       <div id="allowpassworddiv" name="allowpassworddiv" style="display:none">
        <fieldset>
    	  ...
    	  <br/>
          <select id="ustatus" name="ustatus" disabled="disabled" class='moselect'>
                <?php
    	  ...
    	  <br/>
                <select id="utype" name="utype" disabled="disabled" class='moselect' onchange="allowofficeman(this.value)">
                <?php
    	  ...
    	  <br/>
               <select id="officeman" name="officeman" disabled="disabled" class='moselect'>
