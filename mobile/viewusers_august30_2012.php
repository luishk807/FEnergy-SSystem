...
<div id="mbody">
    <div id="message" name="message" class="black" style="text-align:center">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <?Php
	  $query = "select * from task_users order by type and id !='".$user["id"]."'";
	  if($result = mysql_query($query))
	  {
		  if(($num_rows=mysql_num_rows($result))>0)
		  {
			  ...
			  {
				 $usertype = getUserType($row["type"]);
				echo "<tr><td colspan='4' align='center' valign='middle'><hr/></td></tr><tr class='morow'>
				<td align='center' valign='middle'><a href='account_set.php?id=".base64_encode($row["id"])."' class='contlinkb'>".$row["name"]."</a></td>
				<td  align='center' valign='middle'>".$row["email"]."</td>
				<td  align='center' valign='middle'>$usertype</td></tr>";
			  }
		  }
		  else
		  	echo "<tr class='nfound_m'><td colspan='4' class='nfound_m'>No Users Found</td></tr>";
	  }
	  else
	  	echo "<tr class='nfound_m'><td colspan='4' class='nfound_m'>No Users Found</td></tr>";
	  ?>
