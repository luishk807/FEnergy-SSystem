...
if($soffice != 'na' && $soffice !='all')
{
	...
	$sofficexx="";
if(!empty($sagentx) || !empty($soffice) || !empty($umanb) || !empty($sdatef) || !empty($sdatet))
	$showreturn=true;
	...
	// {
     ...
     <hr/>
      ...
      <span id="mform_q">Select Manager: </span>&nbsp;
       <select class='moselect' id="umanb" name="umanb">
       <?php
	   if(!pViewm($userx["type"]))
	   {
	 ...
	 ?>
     <br/>
     <div id="rtotal" style="background:#00477f; font-family:'rockw'; font-size:24pt; color:#FFF; height:80px; text-align:center">
