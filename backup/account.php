    ...
    <div id="bodycont">
        ...
        <div id="bodycont_middle" >
            <div id="bodycont_middle_in">
            	           	<!--start-->
            <div style="text-align:center">Hello <b><u><?php echo $user["username"]; ?></u></b>, To Create a brand new user please fill up the following form.</div><br/>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php
    	    ...
    	    <tr>
    	      ...
    	      <td align="left" valign="middle">
                ...
                <select id="utype" name="utype" disabled="disabled" onchange="allowofficeman(this.value)">
                <?php
           ...
           <tr>
              ...
              <div id="officemandiv" name="officemandiv" <?php echo $showmano; ?>>
    	        ...
    	        <tr>
                  ...
                  <select id="officeman" name="officeman" disabled="disabled">
        ...
        &nbsp;
    	    ...
    	    <tr>
			  ...
			  {
				  ?>
       <a href="createuser.php" onmouseover="document.create.src='images/createbtn.jpg'" onmouseout="document.create.src='images/createbtn.jpg'"><img src="images/createbtn.jpg"  border="0" alt="Create A New User" name="create" /></a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="viewusers.php" onmouseover="document.view.src='images/viewuserbtn.jpg'" onmouseout="document.view.src='images/viewuserbtn.jpg'"><img src="images/viewuserbtn.jpg"  border="0" alt="View All Users" name="view" /></a>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      		<?php
			  }
			  ?>
