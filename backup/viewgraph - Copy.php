...
function graphswitch_month(value)
{
	...
	if(xyear1s.length>0 && xyear2x.length>0)
        ...
        <div id="lbodycont_middle">
            <div id="lbodycont_middle_in">
				...
				if(pView($user["type"]))
				{
					?>
					<div id="tabmenu">
						<div id="tabmenu_in"><a href='viewreport.php' class='contlinkc' >Back</a>&nbsp;&nbsp;&nbsp;<a href='accountrealtotal_oset.php' class='contlinkc' >Edit Real Total</a>&nbsp;&nbsp;&nbsp;<a href='createreport.php' class='contlinkc' >Add Report</a>&nbsp;&nbsp;&nbsp;</div>
				  </div>
				  <br/>
				<?php
				}
