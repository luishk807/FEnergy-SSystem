...
echo "thisyearx:".$thisyearx." nyearx:".$nyearx;
...
echo "<br/>";
echo "week1: ".$week1_total."<br/>";
echo "week2: ".$week2_total."<br/>";
echo "week3: ".$week3_total."<br/>";
echo "week4: ".$week4_total."<br/>";
echo "week5: ".$week5_total."<br/>";
echo "week6: ".$week6_total."<br/>";
?>
...
var timer=null;
function removeperf(remove_date)
{
	if(remove_date.length>0)
	{
		var confirmx=window.confirm("WARNING: YOU ARE ABOUT TO REMOVE ALL THE SALES MADE ON DATE: "+remove_date+" AND CHANGES CANNOT BE REVERTED.\r\n\r\nARE YOU SURE YOU WANT TO PROCEED?\r\n\r\nClick Yes To Proceed Or Cancel To Cancel The Process.");
		if(confirmx==true)
			window.location.href="removeperf.php?d="+remove_date;
	}
}
function printthis()
{
...
.removeperf{
	color:#F00;
	font-size:12pt; font-family:'rockw';
}
.removeperf_no{
	color:#CCC;
	font-size:12pt; font-family:'rockw';
                	...
                	<table width='100%' border='0' cellspacing='0' cellpadding='0'>
                      <tr class='graphheader'>
						...
						if($lessrow)
						{
							...
							{
								$cx=$i;
								$removeperf_check=check_removeperf($weeks[$i]["date1"]);
								if($removeperf_check)
									$remove_link="&nbsp;<a href='javascript:removeperf(\"".$weeks[$i]["date1"]."\")' class='removeperf' title='Remove This Entry' >[x]</a>";
								else
									$remove_link="&nbsp;<span class='removeperf_no' >[x]</span>";
								echo "<td width='12%' align='center' valign='bottom'>Week ".$cx."".$remove_link."<br/><span class='graphrow_date'>".getReportRdate($weeks[$i]["date1"])."</span></td>";
							}
						}
						else
						{
