...
if($weekday !="Thursday")
{
	...
	$ardays=array('2012-09-21','2012-09-22','2012-09-23','2012-09-24','2012-09-25');
	...
	if($weekday !="Thursday")
	{
	//$query="select * from task_users where id in('3','22','14','4','71') and status='1'";
	$query="select * from task_users where id in('3','4','71','2') or type in('8','7') and status='1'";
...
else
{
	...
	$tday="2012-09-21";
	//$ardays=getArrayDays($weekday);
	$ardays=array('2012-09-21','2012-09-23','2012-09-24','2012-09-25','2012-09-26');
	$todaypf = fixdate_comps('invdate_s',$tday);
	$todaypt = fixdate_comps('invdate_s',$today);
	$gtotal=0.00;
	$thisyear=date("Y");
	...
	//if($weekday=="Thursday")
	//{
	//$query = "select * from task_users where id in('3','22','14','4') and status='1'";
	$query="select * from task_users where id in('3','4','71','2') or type in('8','7') and status='1'";
	echo $query;
	//$query = "select * from task_users where id in('1','2')";
	if($result = mysql_query($query))
